        ...
        <div className="h-full space-y-4 flex flex-col items-center justify-center -mt-20">
            ...
            <div className="mx-auto text-center space-y-4 space-x-4">
                { isLoggedIn ? (
                    ...
                    <a href={`/login?return_to=${encodeURIComponent(pathname)}?jai=1`}  className="flex items-center justify-center h-12 mr-3 px-3 text-lg font-medium bg-black text-white border no-underline rounded-lg focus:outline-none hover:shadow-xl">

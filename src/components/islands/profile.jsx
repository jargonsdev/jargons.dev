...
export default function Profile({ isAuthed, userData, authUrl }) {
  ...
  return (
    <div className="relative">
      ...
      {/* Dropdown */}
      <div className={`${!isDropdownOpen && "hidden"} z-50 absolute overflow-hidden mt-2 right-0 bg-white border text-sm divide-y divide-gray-100 rounded-lg shadow-lg min-w-60`}>
          ...
          <div>
            <a href="/logout" class="no-underline flex items-center space-x-2 px-5 py-2 hover:bg-red-100 hover:text-red-900">
              <svg class="size-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">

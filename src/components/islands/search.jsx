...
function SearchTrigger({ size = "md" }) {
  ...
  return (
    <div className="relative flex items-center mt-2 border pl-3 p-1 md:pl-5 md:pr-2 md:py-2 space-x-3 border-gray-400 rounded-lg hover:shadow">
      <div className="text-gray-400">
...
function SearchDialog() {
  ...
  return (
    <div className="fixed left-0 top-0 z-auto p-5 w-full h-full flex justify-center bg-gray-100/30">
      {/* Blur */}
      <div className="absolute w-full h-full left-0 top-0 z-50 backdrop-blur-sm" />

      <div className="flex flex-col bg-white h-fit max-w-4xl w-full shadow-xl z-50 border rounded-lg overflow-hidden">
        {/* Form Field */}

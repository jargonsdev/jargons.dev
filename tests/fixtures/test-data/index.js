...
export const sampleWords = {
  api: {
    title: "API",
    content: "Application Programming Interface (API) is a set of protocols, routines, and tools for building software applications."
  },
  
  algorithm: {
    title: "Algorithm",
    content: "A step-by-step procedure for solving a problem or completing a task in programming."
  },
  
  specialChars: {
    title: "C++",
    content: "A general-purpose programming language with object-oriented features."
  },
  
  longTitle: {
    title: "Very Long Title That Might Cause Issues With URL Generation And File Naming",
...
export const sampleFilePaths = {
  ...
  longTitle: "src/content/dictionary/very-long-title-that-might-cause-issues-with-url-generation-and-file-naming.mdx"
};
...
export const sampleBase64Content = "LS0tCnRpdGxlOiAiQVBJIgotLS0KCkFwcGxpY2F0aW9uIFByb2dyYW1taW5nIEludGVyZmFjZSAoQVBJKSBpcyBhIHNldCBvZiBwcm90b2NvbHMsIHJvdXRpbmVzLCBhbmQgdG9vbHMgZm9yIGJ1aWxkaW5nIHNvZnR3YXJlIGFwcGxpY2F0aW9ucy4=";

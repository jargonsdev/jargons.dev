...
import { sampleWords, sampleRepoDetails } from '../../fixtures/test-data/index.js';
  ...
  describe('PR Title Generation', () => {
    ...
    it('should handle long word titles', async () => {
      ...
      expect(userOctokit.request).toHaveBeenCalledWith(
        'POST /repos/{owner}/{repo}/pulls',
        expect.objectContaining({
          title: 'Dictionary (New Word): Very Long Title That Might Cause Issues With URL Generation And File Naming'
        })
      );
    });
  });
